...
forum_db = client['Guba_Posts']  # raw posts comments from guba
...
# # count Guba_Posts number of stocks cols
# a = mkt_db.list_collection_names()
# mask = [False if 'error' in i else True for i in a] # exclude error_urls collections
# s = pd.Series(a)[mask]
